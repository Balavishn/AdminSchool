...
public class attendance_overall extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_attendance_overall, container, false);
      ...
      //  sec=v.findViewById(R.id.section_attendace_sec_attendace);
        ...
        permance_rank=v.findViewById(R.id.overall_attendance_recycle);
        ...
        get.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
             ...
             //   String class_name=classs.getSelectedItem().toString()+"-"+sec.getSelectedItem().toString();
                ...
                markref= markref.child(classss).child("Attendance");
                Log.d("buttoncalled",classss);
                getdatamark();
